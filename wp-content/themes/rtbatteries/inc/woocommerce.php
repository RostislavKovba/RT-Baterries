 ...
 * @return void
 */
function rtbatteries_woocommerce_setup() {
	add_theme_support(
		'woocommerce',
		array(
...
add_action( 'after_setup_theme', 'rtbatteries_woocommerce_setup' );
 ...
 * @return void
 */
function rtbatteries_woocommerce_scripts() {
	wp_enqueue_style( 'rtbatteries-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), _S_VERSION );
	...
	wp_add_inline_style( 'rtbatteries-woocommerce-style', $inline_font );
}
add_action( 'wp_enqueue_scripts', 'rtbatteries_woocommerce_scripts' );
 ...
 */
function rtbatteries_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'rtbatteries_woocommerce_active_body_class' );
...
if ( ! function_exists( 'rtbatteries_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
	 ...
	 * @return void
	 */
	function rtbatteries_woocommerce_wrapper_before() {
		?>
			<main id="primary" class="site-main">
		<?php
	}
}
add_action( 'woocommerce_before_main_content', 'rtbatteries_woocommerce_wrapper_before' );

if ( ! function_exists( 'rtbatteries_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
	 ...
	 * @return void
	 */
	function rtbatteries_woocommerce_wrapper_after() {
		?>
			</main><!-- #main -->
		<?php
	}
}
add_action( 'woocommerce_after_main_content', 'rtbatteries_woocommerce_wrapper_after' );
...
add_filter('woocommerce_breadcrumb_defaults', 'woocommerce_breadcrumb_custom');
function woocommerce_breadcrumb_custom($args) {
	$args['delimiter'] = '';
