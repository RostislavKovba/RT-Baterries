...
<div class="front-page">
    ...
    <section class="constructor  scroll-y">
        <div class="container">
            ...
            <div class="constructor_slider_wrapper">
                <div class="constructor_slider step-1">
                    <div class="counter">
                    ...
                    <div class="slider">
                        ...
                        <div class="wrapper">
                            <p class="label">Choose polarity</p>
                            <ul>
                                <li>
                                    <p class="type">- / + / -</p>
                        ...
                        <div class="wrapper">
                            <p class="label">Choose cable size </p>
                            <ul>
                                <li>
                        ...
                        <div class="wrapper">
                            <p class="label">Choose battery type </p>
                            <ul>
                                <li>
                    ...
                    <div class="steps_nav">
                        <div class="btn-secondary md prev">
                            <svg viewBox="0 0 29 18" fill="none">
                                <path d="M28 9L4 9" stroke="#333333" stroke-width="2" stroke-linecap="round"/>
                                <path d="M9.87891 16.5L2.37891 9L9.87891 1.5" stroke="#333333" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                            <p>Prev step</p>
                        </div>
                        <div class="btn-secondary md next">
                            ...
                            <svg viewBox="0 0 36 16" fill="none">
                                <path d="M28.7346 1L35 8M35 8L28.7346 15M35 8H0.999998" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                </div>
            </div>
            <div class="constructor_content mobile">
                <p>With <b>4 easy steps</b>, we can match the battery size, length, polarity, and the connector type of your original battery for a 100% fit.</p>
                <div class="line"><b>or</b></div>
                <p>You can see all the CMOS batteries on our website. </p>
                <div class="btn-secondary md plus">
    ...
    <!-- <section class="products-section scroll-y"> -->
    <!-- PRODUCTS SLIDER -->
    <!-- </section> -->
